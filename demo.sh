...
#   3. rcpt 1 -> rcpt 2 (spend 1st received allocations)
_tit "transferring asset from issuer to recipient 1 (spend issuance)"
transfer_asset issuer/rcpt1 2000/0 200/1800 0 0

_tit "transferring asset from issuer to recipient 1 (spend change, using witness vout)"
transfer_asset issuer/rcpt1 1800/200 100/1700 1 0

_tit "transferring asset from recipient 1 to recipient 2 (spend 1st received allocation)"
